...
$target_path = "service/";
     ...
     $user = $db->EditWorkingSiteFinal($ID,$role,$Name,$Photo,$Ladies,$Gents,$Kids,$Bridal,$User,$IP);
             if ($user) {  
          $_SESSION["error"]=1;
        $response["error"] = false;
      header('Location: http://139.59.38.160/Groom/Dashboard/AddFinalService.php');
    } else  {
            $_SESSION["error"]=2;
        $response["error"] = true;
          //header('Location: http://139.59.38.160/Groom/Dashboard/AddFinalService.php');
