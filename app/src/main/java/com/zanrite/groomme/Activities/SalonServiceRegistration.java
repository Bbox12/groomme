...
public class SalonServiceRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Select a service");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(pref.getName()!=null){
                    Intent o = new Intent(SalonServiceRegistration.this, SalonHomePage.class);
                    o.putExtra("from",1);
                    startActivity(o);
                    finish();
                    ...
                    Intent o = new Intent(SalonServiceRegistration.this, ServiceOffer.class);
                    startActivity(o);
                    finish();
                    overridePendingTransition(R.anim.slide_up1, R.anim.rbounce);
                }
        ...
        if(pref.getHeaderImage()!=null){
            ...
            Picasso.Builder builder = new Picasso.Builder(SalonServiceRegistration.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (mService.size() != 0) {
                                ...
                                ServiceAdapter sAdapter = new ServiceAdapter(SalonServiceRegistration.this, mService);
