...
public class SalonServiceDetailsID extends AppCompatActivity implements View.OnClickListener {
    ...
    private String TAG= SalonServiceDetailsID.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent o = new Intent(SalonServiceDetailsID.this, SalonServiceShow.class);
                    startActivity(o);
                    finish();
    ...
    protected void onResume() {
        ...
        if(pref.getFinalServiceID()!=0){
            ...
            _textprimary.setText("Edit Service");
            _textsecondary.setVisibility(View.GONE);
            ...
            StringRequest eventoReq = new StringRequest(com.android.volley.Request.Method.POST, Config_URL.GETSERVICEWITHID,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                for (int i = 0; i < services.length(); i++) {
                                    ...
                                    if(!c.isNull("Name")) {
                                        ...
                                        _detailsSalon = (c.getString("Details_salon"));
                                        _detailHome = (c.getString("Details_home"));
                                    }
                            ...
                            if(_name!=null) {
                                _textsecondary.setText(_name);
                                _textsecondary.setVisibility(View.VISIBLE);
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (!b) {
                    ...
                    if (_atsalon.isChecked()) {
                        _serviceFrom.setVisibility(View.VISIBLE);
                        _serviceFrom.setText("You are servicing from Salon");
                    }
                    if (!_atsalon.isChecked()) {
                        pref.setLocation(0);
                       ViewDialogFailed alert = new ViewDialogFailed();
                        alert.showDialog(SalonServiceDetailsID.this, "Please select your serviceable preference", true);
                    } else {
                        pref.setServiceAt(1);
                    }
                    _detailshome.setText("NA");
                    _home_price.setText("0");
                    _home_time.setText("0");
                } else {
        ...
        _atsalon.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (!b) {
                    ...
                    _detailsalon.setText("NA");
                    _salon_price.setText("0");
                    _salon_time.setText("0");
        ...
        public void showDialog(Activity activity, String msg, Boolean noDate) {
            if (!activity.isFinishing()) {
                ...
                dialogButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent o = new Intent(SalonServiceDetailsID.this, StoreServiceInformation.class);
                        startActivity(o);
                        finish();
                        overridePendingTransition(R.anim.slide_up1, R.anim.rbounce);
                        dialog1.dismiss();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.submit:
                    ...
                    StringRequest eventoReq = new StringRequest(com.android.volley.Request.Method.POST, Config_URL.STORE_SALONHOME_SERVICE_ID,
                            new Response.Listener<String>() {
                                @Override
                                public void onResponse(String response) {
                                    ...
                                    if (par[1].contains("false")) {
                                        ...
                                        alert.showDialog(SalonServiceDetailsID.this, "Succesfully stored information.",false);

                                    }else{
                                        ViewDialogFailed alert = new ViewDialogFailed();
                                        alert.showDialog(SalonServiceDetailsID.this, "Failed to store information! Please try another time.",true);
                                    }
